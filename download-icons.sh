...
# Format: SERVICE_ICON_URL_SERVICENAME=https://url.to/icon.png
declare -A ICON_URLS=(
    [DASHBOARD]="${DASHBOARD_ICON_URL}"
    [SONARR]="${SERVICE_ICON_URL_SONARR}"
    [RADARR]="${SERVICE_ICON_URL_RADARR}"
    [WHISPARR]="${SERVICE_ICON_URL_WHISPARR}"
    [LIDARR]="${SERVICE_ICON_URL_LIDARR}"
    [PROWLARR]="${SERVICE_ICON_URL_PROWLARR}"
    [JACKETT]="${SERVICE_ICON_URL_JACKETT}"
    [SEERR]="${SERVICE_ICON_URL_SEERR}"
    [BAZARR]="${SERVICE_ICON_URL_BAZARR}"
    [JELLYFIN]="${SERVICE_ICON_URL_JELLYFIN}"
    [EMBY]="${SERVICE_ICON_URL_EMBY}"
    [PLEX]="${SERVICE_ICON_URL_PLEX}"
    [TAUTULLI]="${SERVICE_ICON_URL_TAUTULLI}"
    [MAINTAINERR]="${SERVICE_ICON_URL_MAINTAINERR}"
    [TRANSMISSION]="${SERVICE_ICON_URL_TRANSMISSION}"
    [QBITTORRENT]="${SERVICE_ICON_URL_QBITTORRENT}"
    [SABNZBD]="${SERVICE_ICON_URL_SABNZBD}"
    [DELUGE]="${SERVICE_ICON_URL_DELUGE}"
    [NZBGET]="${SERVICE_ICON_URL_NZBGET}"
    [NZBHYDRA]="${SERVICE_ICON_URL_NZBHYDRA}"
)
